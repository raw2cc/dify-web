const translation = {
    ...
    feature: {
        ...
        moderation: {
            ...
            modal: {
                ...
                keywords: {
                    ...
                    placeholder: '每行一个，用换行符分隔。每行最多 100 个字符，最多100行。',
                    line: '行',
                },
                content: {
                    input: '审查输入内容',
                    ...
                    placeholder: '请输入预设回复内容，控制在50个字以内',
        ...
        fileUpload: {
            title: '文件上传',
            description: '在聊天输入框中，用户可上传配置的文件。文件类型包括图片、文档、音频、视频等',
